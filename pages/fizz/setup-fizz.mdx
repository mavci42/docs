...
5. For the Stellar phase and beyond, node registration requires:
...
6. Now click on the "Register Your Fizz Node" button. 

7. Once you confirm all the transactions including the deposit, your node will be officially registered in the Spheron network, and you can proceed to the next steps.
...
![Fizz Generate Command](assets/fizz-generate-command.png)
...
wsl --install
```
![Enable WSL Command](assets/enable-wsl.png)
...
![Enable Docker Ubuntu](assets/enable-docker-ubuntu.png)

7. Go to Resource > WSL Integration > Enable Ubuntu. Click "Apply & Restart".
![Enable Docker Ubuntu - 2](assets/enable-docker-ubuntu-2.png)
...
![Fizz Generate Command](assets/generate-command-windows.png)
